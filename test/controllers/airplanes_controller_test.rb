...
class AirplanesControllerTest < ActionController::TestCase
  ...
  test "should create airplane" do
    assert_difference('Airplane.count') do
      post :create, airplane: { empresa: @airplane.empresa, numero: @airplane.numero, piloto: @airplane.piloto, vuelo: @airplane.vuelo }
    end
  ...
  test "should update airplane" do
    patch :update, id: @airplane, airplane: { empresa: @airplane.empresa, numero: @airplane.numero, piloto: @airplane.piloto, vuelo: @airplane.vuelo }
    assert_redirected_to airplane_path(assigns(:airplane))
  end
