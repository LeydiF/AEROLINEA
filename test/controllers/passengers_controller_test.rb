...
class PassengersControllerTest < ActionController::TestCase
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post :create, passenger: { apellido: @passenger.apellido, identificacion: @passenger.identificacion, nombre: @passenger.nombre, vuelo: @passenger.vuelo }
    end
  ...
  test "should update passenger" do
    patch :update, id: @passenger, passenger: { apellido: @passenger.apellido, identificacion: @passenger.identificacion, nombre: @passenger.nombre, vuelo: @passenger.vuelo }
    assert_redirected_to passenger_path(assigns(:passenger))
  end
